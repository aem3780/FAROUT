...
const images = ['SpriteStrips/awkwardsprite.png', 'SpriteStrips/beautifulsprite.png', 'SpriteStrips/crazysprite.png', 'SpriteStrips/joyfulsprite.png', 'SpriteStrips/proudsprite.png', 'SpriteStrips/sillysprite.png', 'SpriteStrips/spookysprite.png', 'SpriteStrips/tastysprite.png'];
function imgRandom() {
...
<div class="centered-container">
    ...
    <div class="content-block"> 
        <div class="ui-back"> </div>
        <img src="./assets/back.png" class="closebtn" onclick="closeMemory()">
        <div class="title-text">
            <h3> A <span>crazy</span> memory </h3>
        </div>
        <div class="submission-text">
            <h2> When I went snowboarding with all my friends! </h2>
        </div>
        <div class="submission-data"><h4> SUBMITTED ON 02/04/23 10:34am </h4></div>
    </div>
</div>
</div>
`;
...
const colors = ["#FFC52E", "#DF312F", "#FF3270", "#F0EFED", "#065CE4", "#05B0DB", "#65FBEB", "#09D379"];
